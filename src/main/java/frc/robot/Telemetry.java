...
import frc.robot.ctre.SwerveDrivetrain.SwerveDriveState;
...
public class Telemetry {
    ...
    DoublePublisher velocityW = driveStats.getDoubleTopic("Angular Velocity").publish();
    ...
    public void telemeterize(SwerveDriveState state) {
        ...
        speed.set(Math.sqrt(state.ChassisSpeeds.vxMetersPerSecond * state.ChassisSpeeds.vxMetersPerSecond + state.ChassisSpeeds.vyMetersPerSecond * state.ChassisSpeeds.vyMetersPerSecond));
        velocityX.set(state.ChassisSpeeds.vxMetersPerSecond);
        velocityY.set(state.ChassisSpeeds.vyMetersPerSecond);
        velocityW.set(state.ChassisSpeeds.omegaRadiansPerSecond);
